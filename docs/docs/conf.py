...
# experimental build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/experimental/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/experimental",
    ...
    "repository_url": "https://github.com/collective/experimental",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/experimental/edit/main/docs/",
# }
...
ogp_site_name = "experimental Documentation"
ogp_type = "website"
...
htmlhelp_basename = "experimentalDocumentation"
